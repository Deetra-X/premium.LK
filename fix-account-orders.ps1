// Create a PowerShell script to replace the file
$content = @"
// Required imports
...
// Export default as an object with all functions to support both named and default imports
export default {
  createAccountOrder,
  getAccountOrders,
  getAccountOrderById,
...
$filePath = "c:\Users\Deenath Damsinghe\Downloads\POS-main\src\api\AccountOrders.ts"
Set-Content -Path $filePath -Value $content -Force

Write-Host "AccountOrders.ts has been successfully replaced with the fixed version."
